    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "    intent_router -.->|food| food_handler;\n",
                "    intent_router -.->|exercise| exercise_handler;\n",
                "    intent_router -.->|rag| rag_handler;\n",
                "    intent_router -.->|general| general_handler;\n",
                "    food_handler --> self_rag_evaluator;\n",
                "    exercise_handler --> self_rag_evaluator;\n",
                "    rag_handler --> self_rag_evaluator;\n",
                "    general_handler --> self_rag_evaluator;\n",
                "    self_rag_evaluator -.->|passed| human_in_the_loop;\n",
                "    self_rag_evaluator ==>|retry 피드백 순환| intent_router;\n",
                "    human_in_the_loop --> END([🏁 END]);\"\"\"\n",
                "\n",
                ...
                "            encoded = base64.b64encode(mmd_clean.encode(\"utf-8\")).decode(\"ascii\")\n",
                ...
                "workflow.add_conditional_edges(\n",
                "    \"self_rag_evaluator\",\n",
                "    lambda s: \"intent_router\" if s.get(\"quality_score\") == \"retry\" else \"human_in_the_loop\",\n",
                "    {\"human_in_the_loop\": \"human_in_the_loop\", \"intent_router\": \"intent_router\"}\n",
                ")\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "try:\n",
                "    # 1. 굵은 피드백 순환 화살표(==>)가 들어간 Mermaid 렌더링\n",
                "    ctx = ssl._create_unverified_context()\n",
                "    encoded = base64.b64encode(mmd.encode('utf-8')).decode('ascii')\n",
                "    url = f\"https://mermaid.ink/img/{encoded}\"\n",
                "    req = urllib.request.Request(url, headers={'User-Agent': 'Mozilla/5.0'})\n",
                "    with urllib.request.urlopen(req, context=ctx, timeout=8) as response:\n",
...
print(f"✅ 환경 독립적 LangGraph 호환 주피터 노트북 생성 완료: {output_path}")
