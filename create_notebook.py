    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "\n",
                "def food_node(state: DietState) -> Dict[str, Any]:\n",
                "    return {\"tool_results\": {\"source\": \"search_food_nutrition\"}}\n",
                "\n",
                "def exercise_node(state: DietState) -> Dict[str, Any]:\n",
                "    return {\"tool_results\": {\"source\": \"calculate_exercise_calories\"}}\n",
                "\n",
                "def rag_node(state: DietState) -> Dict[str, Any]:\n",
                "    return {\"tool_results\": {\"source\": \"search_nutrition_knowledge\"}}\n",
                "\n",
                "def general_node(state: DietState) -> Dict[str, Any]:\n",
                "    return {\"tool_results\": {\"source\": \"general_coaching\"}}\n",
                "\n",
                "def self_rag_evaluation(state: DietState) -> Dict[str, Any]:\n",
                "    \"\"\"Self-RAG 3단계 품질 게이트 노드\"\"\"\n",
                "    return {\"quality_score\": \"passed\"}\n",
                "\n",
                "def human_in_the_loop(state: DietState) -> Dict[str, Any]:\n",
                "    \"\"\"Human-in-the-Loop 스마트 저장 컨펌 노드\"\"\"\n",
                "    return {\"response\": \"Ready for DB smart save\"}\n",
                "\n",
                "# 3. 상태 그래프(StateGraph) 구성\n",
                ...
                "\n",
                "def route_condition(state: DietState) -> Literal[\"food_handler\", \"exercise_handler\", \"rag_handler\", \"general_handler\"]:\n",
                "    return f\"{state['intent']}_handler\" if f\"{state['intent']}_handler\" in [\"food_handler\", \"exercise_handler\", \"rag_handler\"] else \"general_handler\"\n",
                "\n",
        ...
        },
        {
            ...
            "source": [
                ...
                "print(\"```mermaid\"); print(mmd); print(\"```\")  # 항상 보이는 텍스트 소스\n",
                "try:\n",
                "    display(Image(graph.draw_mermaid_png()))   # mermaid.ink 가능 시 PNG\n",
                "except Exception as e:\n",
                "    print(f\"[PNG skip: {e}] — ASCII fallback ↓\")\n",
                "    graph.print_ascii()"
            ]
        },
        {
